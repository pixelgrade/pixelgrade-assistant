...
function pixassist_get_default_config( $original_theme_slug ) {
	...
	$config['l10n'] = array(
		...
		'authenticatorDashboardConnectedSuccessContent' => wp_kses_post( __( 'Well done, <strong>{{username}}</strong>! Your website is successfully connected with {{shopdomain}}. Carry on and install the recommended plugins or starter content in the blink of an eye.', '__plugin_txtd' ) ),
	...
	$config['knowledgeBase'] = array(
		...
		'l10n'       => array(
			...
			'ticketSendSuccessTitle'    => esc_html__( '👍 You\'ve got our attention!', '__plugin_txtd' ),
...
<p>Please bear in mind that we do our best to answer every support request as soon as possible. But, being humans and all, we may take a few hours or, if we are talking about weekends, a day. Thank you for your patience. We don\'t take it lightly.</p>', '__plugin_txtd' ) ),
			'ticketSendSuccessGreeting' => wp_kses_post( __( 'Keep being awesome,<br><em>The Pixelgrade crew</em>', '__plugin_txtd' ) ),
			'ticketSendingLabel'        => esc_html__( 'Submitting the ticket...', '__plugin_txtd' ),
			'ticketSendError'                     => esc_html__( 'Something went wrong and we couldn\'t submit your ticket. If the problem persists, please let us know about it at {{support_email_address_link}}.', '__plugin_txtd' ),
			...
			'searchFieldLabel'          => esc_html__( 'Search through the documentation', '__plugin_txtd' ),
			'searchFieldHelper'         => esc_html__( '* type 3+ characters to begin', '__plugin_txtd' ),
			'searchFieldResetLabel'     => esc_html__( 'Reset the searched text', '__plugin_txtd' ),
