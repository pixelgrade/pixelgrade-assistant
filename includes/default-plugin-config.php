...
function pixassist_get_default_config( $original_theme_slug ) {
	...
	$config['l10n'] = array(
		...
		'themeHelpSearchPlaceholder'                    => esc_html__( 'Search the documentation…', '__plugin_txtd' ),
		'themeHelpLoading'                              => esc_html__( 'Loading documentation…', '__plugin_txtd' ),
		'themeHelpAllTopics'                            => esc_html__( 'All topics', '__plugin_txtd' ),
		'themeHelpBack'                                 => esc_html__( 'Back', '__plugin_txtd' ),
		'themeHelpNoResults'                            => esc_html__( 'No matching articles.', '__plugin_txtd' ),
		'themeHelpFeedbackPrompt'                       => esc_html__( 'Was this helpful?', '__plugin_txtd' ),
		'themeHelpFeedbackYes'                          => esc_html__( 'Yes', '__plugin_txtd' ),
		'themeHelpFeedbackNo'                           => esc_html__( 'No', '__plugin_txtd' ),
		'themeHelpFeedbackThanks'                       => esc_html__( 'Thanks for your feedback!', '__plugin_txtd' ),
		'themeHelpReadOnline'                           => esc_html__( 'Read this article online', '__plugin_txtd' ),
		'themeHelpFallback'                             => esc_html__( 'Browse the full documentation for step-by-step guides and answers.', '__plugin_txtd' ),
		'themeHelpBrowseDocs'                           => esc_html__( 'Browse the documentation', '__plugin_txtd' ),
