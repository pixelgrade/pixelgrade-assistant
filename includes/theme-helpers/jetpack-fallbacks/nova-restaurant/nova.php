	...
	*/
	...
	class Nova_Restaurant {
		...
		function setup_menu_item_columns() {
			add_filter( sprintf( 'manage_edit-%s_sortable_columns', self::MENU_ITEM_POST_TYPE ), array(
				$this,
				'no_title_sorting'
			) );
			add_filter( sprintf( 'manage_%s_posts_columns', self::MENU_ITEM_POST_TYPE ), array(
				$this,
				'menu_item_columns'
			) );

			add_action( sprintf( 'manage_%s_posts_custom_column', self::MENU_ITEM_POST_TYPE ), array(
				$this,
		...
		function register_menu_item_meta_boxes() {
			...
			add_meta_box( 'menu_item_price', __( 'Price', 'jetpack' ), array(
				$this,
