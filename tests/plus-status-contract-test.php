...
assert_same( 'https://example.test/wp-admin/themes.php?page=pixelgrade&tab=account-license', $status['plus_settings_url'], 'The hosted Account & License URL should pass through unchanged.' );
